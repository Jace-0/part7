...
const CreateNew = (props) => {
  const [content, contentOps] = useField('text', 'content')
  const [author, authorOps] = useField('text','author')
  const [info, infoOps] = useField('text', 'info')
...
const App = () => {
  ...
  const addNew = (anecdote) => {
    ...
    console.log('Current state of anecdote' ,anecdotes)
    Navigate('/')
